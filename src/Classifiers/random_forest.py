...
class RF:
    ...
    def __init__(self, x_train, y_train, x_test, y_test, save_path, save_model_path):
    ...
    def rf_model(self):
        ...
        model = RandomForestClassifier(n_estimators=100, random_state=42, max_features="sqrt", min_samples_split=2,
        ...
        print(f"Metrics of Random Forest: {cm_metrics}")
        plt.figure()
        ...
        ax.set_title("RF Result", fontsize=12)
